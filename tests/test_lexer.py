...
class TestLexer:
    ...
    # FIXED: "/*" (Unclosed comment) -> DIV, MUL (Partial match fallback)
    ...
    # FIXED: "/*/" (Partial unclosed) -> DIV, MUL, DIV
    ...
    # FIXED: Ends in backslash is Unclosed String, not IllegalEscape (no char to check)
